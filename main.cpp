...
int main()
{
	...
	SQLCHAR* serverName = const_cast<SQLCHAR*>(reinterpret_cast<const SQLCHAR*>("hiwi"));
	SQLCHAR* userName = const_cast<SQLCHAR*>(reinterpret_cast<const SQLCHAR*>("Harshi"));
	SQLCHAR* password = const_cast<SQLCHAR*>(reinterpret_cast<const SQLCHAR*>("Harshi@9903"));
	...
	cout << SQLConnect(sqlconnectionhandle, (SQLCHAR*)"Harshi", SQL_NTS, (SQLCHAR*)"sa", SQL_NTS, (SQLCHAR*)"Harshi@9903", SQL_NTS);
	switch (SQLConnect(sqlconnectionhandle, (SQLCHAR*) "hiwi", SQL_NTS, (SQLCHAR*)"sa", SQL_NTS, (SQLCHAR*)"Harshi@9903", SQL_NTS))    //this is the connection string to connect SQLServer.
	{
