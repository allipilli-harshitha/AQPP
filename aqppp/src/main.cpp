...
int main()
{
	...
	switch (SQLConnect(sqlconnectionhandle, (SQLCHAR*) L"hiwi", SQL_NTS, (SQLCHAR*)L"Harshi", SQL_NTS, (SQLCHAR*)L"Harshi@9903", SQL_NTS))    //this is the connection string to connect SQLServer.
	{
